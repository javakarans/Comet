...
//            List<BranchBrand> branchBrandList = branchDetailsDaoImp.getAlBranchBrand();
//            branchDetailsWrapperList = new ArrayList<BranchDetailsWrapper>(branchBrandList.size());
//            for (BranchBrand branchBrand : branchBrandList) {
//                branchDetailsWrapperList.add(new BranchDetailsWrapper(branchBrand));
//            }
//    }
//
//    public void addItem()
